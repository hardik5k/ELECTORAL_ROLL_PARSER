...
(function(e, d, a, f) {
    ...
    e.fn.twbsPagination.defaults = {totalPages: 0, startPage: 1, visiblePages: 5, href: "", hrefVariable: "{{number}}", first: "&laquo;", prev: "&lsaquo;", next: "&rsaquo;", last: "&raquo;", onPageClick: null, paginationClass: "pagination", nextClass: "next", prevClass: "prev", lastClass: "last", firstClass: "first", pageClass: "page", activeClass: "active", disabledClass: "disabled"};
